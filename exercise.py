...
# Checking if views have been added to all articles
print(my_dict['response']['results'])

# Exercise 2:
def read_article(input_dictionary):
    random_article = random.randint(0, len(my_dict['response']['results']))
    input_dictionary['response']['results'][random_article]['views'] += 1
...
# Exercise 3:
def display_views(input_dictionary):
    for i in range(len(my_dict['response']['results'])):
